const serviceTermsText = String.raw`제 1 장 총칙

제 1 조 (목적)
본 약관은 커넥트마케팅연구소가 운영하는 웹 사이트 웨이컵(https://wake-up.kr)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
...
<부칙>
본 약관은 2019년 10월 1일부터 적용한다.
`;

const collectionText = `① <커넥트마케팅연구소>('https://wake-up.kr'이하 '웨이컵(Wake-Up)')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.

② <커넥트마케팅연구소>('https://wake-up.kr')은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.


1. <커넥트마케팅연구소>
- 개인정보를 제공받는 자 : 커넥트마케팅연구소
- 제공받는 자의 개인정보 이용목적 : 이메일, 휴대전화번호, 자택전화번호, 로그인ID, 성별, 생년월일, 이름, 은행계좌정보, 서비스 이용 기록, 접속 로그, 접속 IP 정보, 결제기록
- 제공받는 자의 보유.이용기간: 3년

`;

export { serviceTermsText, collectionText };
